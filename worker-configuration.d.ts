/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: baf825fe469e61a58f80885825fee4f5)
// Runtime types generated with workerd@1.20260405.1 2026-03-24 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSION: KVNamespace;
		LAST_LISTENED_KV: KVNamespace;
		ASSETS: Fetcher;
		NAVIDROME_CLIENT_NAME: "learningis1.st";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NAVIDROME_CLIENT_NAME" | "NAVIDROME_API_VERSION" | "NAVIDROME_BASE_URL" | "NAVIDROME_USERNAME" | "NAVIDROME_TOKEN" | "NAVIDROME_SALT">> {}
}
